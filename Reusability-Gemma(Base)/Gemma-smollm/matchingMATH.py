...
df = pd.read_csv('gemma3_smollm2_math_final_results.csv')
...
valid_df = df[(df['gemma3_answer'] != "") & (df['smollm2_answer'] != "")]
match_rate = (valid_df['gemma3_answer'].str.lower() == valid_df['smollm2_answer'].str.lower()).mean()
