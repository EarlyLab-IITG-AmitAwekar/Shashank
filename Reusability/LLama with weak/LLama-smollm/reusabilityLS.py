...
GEMMA3_MODEL = 'smollm2:1.7b'
LLAMA_RESULTS_CSV_PATH = '../../llama_gsm8k_results.csv'
FINAL_RESULTS_CSV_PATH = 'llama_smollm2_gsm8k_final_results.csv'
SUMMARY_CSV_PATH = 'llama_smollm2_gsm8k_accuracy_summary.csv'
...
def main():
    ...
    print("=== SmolLM2 Processing and Evaluation Script ===")
    ...
    for idx, row in tqdm(df_llama.iterrows(), total=len(df_llama), desc="Processing SmolLM2"):
        ...
        # SmolLM2 responses with error handling
        try:
