...
FINAL_RESULTS_CSV_PATH = 'llama_smollm2_math_final_results.csv'
SUMMARY_CSV_PATH = 'llama_smollm2_math_accuracy_summary.csv'
CHUNK_SAVE_SIZE = 20
...
def main():
    print("=== Enhanced SmolLM2 Processing with Parallel Execution ===")
    ...
    try:
        ...
        # Display results
        print("\n" + "="*60)
        print("FINAL RESULTS (SmolLM2 Optimized Processing)")
        print("="*60)
