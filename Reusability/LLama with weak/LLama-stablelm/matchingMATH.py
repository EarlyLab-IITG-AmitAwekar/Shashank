...
df = pd.read_csv('llama_stablelm2_math_final_results.csv')
...
valid_df = df[(df['llama_answer'] != "") & (df['stablelm2_answer'] != "")]
match_rate = (valid_df['llama_answer'].str.lower() == valid_df['stablelm2_answer'].str.lower()).mean()
