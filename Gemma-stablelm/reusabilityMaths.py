...
FINAL_RESULTS_CSV_PATH = 'gemma3_stablelm2_math_final_results.csv'
SUMMARY_CSV_PATH = 'gemma3_stablelm2_math_accuracy_summary.csv'
CHUNK_SAVE_SIZE = 20
...
def main():
    print("=== Enhanced StableLM2 Processing with Parallel Execution (Gemma3 Dataset) ===")
    ...
    try:
        ...
        # Display results
        print("\n" + "="*60)
        print("FINAL RESULTS (StableLM2 vs Gemma3 Optimized Processing)")
        print("="*60)
